...
CALL mvn install:install-file -DgroupId=net.sf.barcode4j -DartifactId=barcode4j -Dversion=latest -Dpackaging=jar -DgeneratePom=true -Dfile=barcode4j.jar

CALL mvn install:install-file -DgroupId=net.sf.barcode4j -DartifactId=barcode4j-fop-ext -Dversion=latest -Dpackaging=jar -DgeneratePom=true -Dfile=barcode4j-fop-ext.jar
